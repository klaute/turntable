...
void printHTMLCtrlPanel(WiFiClient client, String ip)
{
  ...
  client.println("function tt_saveCfg(){callURL(getBaseURL()+\"/SAVE_\"+document.getElementById(\"idx\").value);}function tt_loadCfg(){callURL(getBaseURL()+\"/LOAD_\"+document.getElementById(\"idx\").value);}</script>");
  client.println("<body>");
  client.println("<br>");
